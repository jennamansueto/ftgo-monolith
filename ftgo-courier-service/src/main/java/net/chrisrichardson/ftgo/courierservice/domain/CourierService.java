...
public class CourierService {
  ...
  @Transactional
  public void addAction(long courierId, long orderId, String actionType, LocalDateTime time) {
    Courier courier = courierRepository.findById(courierId).get();
    courier.addAction(new Action(ActionType.valueOf(actionType), orderId, time));
  }
