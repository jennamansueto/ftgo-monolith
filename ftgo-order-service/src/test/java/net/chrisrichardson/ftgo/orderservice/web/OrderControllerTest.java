...
import net.chrisrichardson.ftgo.orderservice.domain.OrderDeliveryService;
...
public class OrderControllerTest {
  ...
  public void setUp() throws Exception {
    ...
    orderController = new OrderController(orderService, orderRepository, orderDeliveryService);
  }
  ...
  public void shouldFindNotOrder() {
    ...
    given().
            standaloneSetup(configureControllers(new OrderController(orderService, orderRepository, orderDeliveryService))).
    when().
            get("/orders/1").
    then().
            statusCode(404)
