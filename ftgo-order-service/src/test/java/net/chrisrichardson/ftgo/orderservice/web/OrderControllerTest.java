...
public class OrderControllerTest {
  ...
  public void setUp() throws Exception {
    ...
    orderController = new OrderController(orderService, orderRepository, orderCreator);
  }
  ...
  public void shouldFindNotOrder() {
    ...
    given().
            standaloneSetup(configureControllers(new OrderController(orderService, orderRepository, orderCreator))).
    when().
            get("/orders/1").
    then().
            statusCode(404)
