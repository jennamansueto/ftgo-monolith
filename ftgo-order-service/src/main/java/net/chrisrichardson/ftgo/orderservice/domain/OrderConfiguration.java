...
public class OrderConfiguration {
  ...
  @Bean
  public OrderAcceptanceFacade orderAcceptanceFacade(OrderService orderService, CourierServiceClient courierServiceClient) {
    return new OrderAcceptanceFacade(orderService, courierServiceClient);
  }
