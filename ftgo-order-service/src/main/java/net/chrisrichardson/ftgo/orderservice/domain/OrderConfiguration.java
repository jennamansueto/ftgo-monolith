...
public class OrderConfiguration {
  ...
  public ConsumerServiceClient consumerServiceClient(RestTemplate consumerServiceRestTemplate,
                                                     @Value("${consumer.service.url:http://consumer-service:8082}") String consumerServiceUrl) {
    return new ConsumerServiceClient(consumerServiceRestTemplate, consumerServiceUrl);
  }

  @Bean
  public OrderCreator orderCreator(OrderService orderService, ConsumerServiceClient consumerServiceClient) {
    return new OrderCreator(orderService, consumerServiceClient);
  }
