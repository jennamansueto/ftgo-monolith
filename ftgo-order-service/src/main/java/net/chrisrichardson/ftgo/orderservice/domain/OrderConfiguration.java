...
public class OrderConfiguration {
  ...
  @Bean
  public ConsumerServiceClient consumerServiceClient(@Value("${consumer.service.url}") String consumerServiceUrl,
                                                     RestTemplate restTemplate) {
    return new ConsumerServiceClient(consumerServiceUrl, restTemplate);
  }
