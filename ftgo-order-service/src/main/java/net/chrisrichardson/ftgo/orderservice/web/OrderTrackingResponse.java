...
public class OrderTrackingResponse {
  ...
  public OrderTrackingResponse(long orderId, String state, LocalDateTime readyBy,
                               LocalDateTime acceptTime, LocalDateTime preparingTime,
                               LocalDateTime readyForPickupTime, LocalDateTime pickedUpTime,
                               LocalDateTime deliveredTime, LocalDateTime estimatedPickupTime,
                               LocalDateTime estimatedDeliveryTime, Long assignedCourierId,
