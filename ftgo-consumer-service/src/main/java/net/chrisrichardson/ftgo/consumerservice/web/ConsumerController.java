...
public class ConsumerController {
  ...
  @RequestMapping(method= RequestMethod.POST, path="/validate-order")
  public ResponseEntity<Void> validateOrderForConsumer(@RequestBody ValidateOrderForConsumerRequest request) {
    try {
      consumerService.validateOrderForConsumer(request.getConsumerId(), request.getOrderTotal());
