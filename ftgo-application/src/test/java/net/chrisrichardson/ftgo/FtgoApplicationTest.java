...
import net.chrisrichardson.ftgo.orderservice.domain.client.ConsumerServiceClient;
...
public class FtgoApplicationTest extends AbstractEndToEndTests {
  ...
  public static class Config {
    ...
    @Bean
    public ConsumerServiceClient consumerServiceClient(ConsumerService consumerService) {
