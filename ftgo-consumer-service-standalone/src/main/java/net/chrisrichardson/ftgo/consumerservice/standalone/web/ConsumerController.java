...
import net.chrisrichardson.ftgo.consumerservice.standalone.domain.ConsumerNotFoundException;
import net.chrisrichardson.ftgo.consumerservice.standalone.domain.ConsumerService;
import net.chrisrichardson.ftgo.consumerservice.standalone.domain.ConsumerVerificationFailedException;
